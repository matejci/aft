...
module TakkoStructs
  ...
  HashtagPost = Struct.new('HashtagPost', :id, :description, :media_thumbnail_dimensions, :media_thumbnail, :user, :link_title, :views_count)
  ...
  LBPost = Struct.new('LBPost', :id, :description, :media_thumbnail_dimensions, :media_thumbnail, :user, :link_title, :views_count,
