...
import PartTwoPhone from './SignUpFormComponents/PartTwoPhone'
import PartTwoEmail from './SignUpFormComponents/PartTwoEmail'
import PartThree from './SignUpFormComponents/PartThree'
// import PartFour from './SignUpFormComponents/PartFour'
  ...
  render() {
    ...
    return (
      <div className={styles.usersFormWrap}>
        ...
        { this.state.emailPhoneToggle=="phone" ? (
          <StepWizard
            className={"h-100"}
            // nav={<Nav />}
            isLazyMount={true}
            ...
            <PartOne user={this.state.user} updateUserState={this.updateUserState} link={this.state.link} emailPhoneToggle={this.state.emailPhoneToggle} updateEmailPhoneToggleState={this.updateEmailPhoneToggleState} />

            <PartTwoPhone user={this.state.user} updateUserState={this.updateUserState} />

            {/*<PartTwoEmail user={this.state.user} updateUserState={this.updateUserState} />*/}

            <PartTwo user={this.state.user} updateUserState={this.updateUserState} />

            {/* <PartThree user={this.state.user} updateUserState={this.updateUserState} /> */ }

            {/*<PartFour user={this.state.user} updateUserState={this.updateUserState} toggleModal={this.toggleModal} toggleConfetti={this.props.toggleConfetti} />*/}
          ...
          <StepWizard
            ...
            {/*<PartThree user={this.state.user} updateUserState={this.updateUserState} toggleModal={this.toggleModal} toggleConfetti={this.props.toggleConfetti} /> */}
