              ...
              <Form className="subscribersForm" onSubmit={ (e) => this.handleSubmit(e, this.props.updateSubscriberState)}>
                ...
                <FormGroup className={styles.formGroup}>
                  <TextField
                    ...
                    name="firstName"
                    id="firstName"
                    className={this.state.errors.firstName ? styles.formControl+" error" : styles.formControl}
                    type="text"
                  ...
                  <span className={styles.errorMessage}>{this.state.errors.firstName}</span>
                </FormGroup>
                ...
                <FormGroup className={styles.formGroup}>
                  <TextField
                    ...
                    name="lastName"
                    id="lastName"
                    className={this.state.errors.lastName ? styles.formControl+" error" : styles.formControl}
                    type="text"
                    ...
                    variant="filled"
                    onChange={this.handleInputChange} />
                  <span className={styles.errorMessage}>{this.state.errors.lastName}</span>
                </FormGroup>
