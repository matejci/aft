...
export default class EmbedIndex extends React.Component {
  ...
  render() {
    ...
    const Takko = () => {
      ...
      const bottomHeight = Math.round(height*0.125)
        ...
        <React.Fragment>
          <div ref={ref} className={styles.embedTortilla}>
            ...
            <div className={styles.bottom} style={{ height: bottomHeight }}>
              <EmbedBottom ref={instance => { this.EmbedBottom = instance }} selectedPost={this.selectedPost()} bottomHeight={this.bottomBoundsHeight} />
            </div>
